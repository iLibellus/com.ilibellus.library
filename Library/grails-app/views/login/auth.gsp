    ...
    <div class="row">
        ...
        <div class="col-xs-6 col-md-6 col-lg-2 col-lg-push">
            ...
            <div>
                ...
                <div>
                <fieldset>
                    <g:form uri="${postUrl}" role="form" method='POST' id='indexLoginForm' class='form-horizontal' autocomplete='off' >               
                        <div style="margin-bottom: 10px" class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
							<input id="index_username" type="text" class="form-control" name="j_username" value="" placeholder="${message(code:"springSecurity.login.username.label")}">                                        
                       </div>
                       <div style="margin-bottom: 10px" class="input-group">
                       		<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                            <input id="index_password" type="password" class="form-control" name="j_password" placeholder="${message(code:"springSecurity.login.password.label")}">
						</div>
                        <div class="checkbox">
    					<label>
      						<input type="checkbox"> 
